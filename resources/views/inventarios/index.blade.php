                  ...
                  <table id="AdministradorTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                          ...
                          <tr>
                              ...
                              <td>
                              <form  action="{{ route('inventarios.destroy',$inventario->COD_INVENTARIO) }}" method="POST">
                            <a href="/inventarios/{{$inventario->COD_INVENTARIO}}/edit" class="btn btn-info">Editar</a>         
                                @csrf
                                @method('DELETE')
                      ...
                      <a href="{{ route('inventarios.create') }}" class="btn btn-success">Registrar</a>
